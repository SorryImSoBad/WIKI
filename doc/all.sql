...
values (1, 'Spring Boot 入门教程', '零基础入门Java');
insert into `ebook` (id, name, description)
values (2, 'Vue 入门教程', '零基础入门Vue');
insert into `ebook` (id, name, description)
values (3, 'Python 入门教程', '零基础入门Python');
insert into `ebook` (id, name, description)
values (4, 'Mysql 入门教程', '零基础入门Mysql');
insert into `ebook` (id, name, description)
values (5, 'Oracle 入门教程', '零基础入门Oracle');
